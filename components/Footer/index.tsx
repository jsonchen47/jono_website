              ...
              >
                <a href="/" className="relative">
                  <Image
                    width={170}
                    height={80}
                    src="/images/logo/jono_logo_text_light.png"
                    alt="Logo"
                  ...
                  <Image
                    width={170}
                    height={80}
                    src="/images/logo/jono_logo_text_dark.png"
                    alt="Logo"
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <ul className="flex items-center gap-8">
                ...
                <li>
                  <a href="privacy_policy" className="hover:text-primary">
                    Privacy Policy
                  </a>
                </li>
                <li>
                  <a href="terms_of_service" className="hover:text-primary">
                    Terms of Service
                  </a>
                </li>
              </ul>
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Side Project. Made with ❤️ as a side project
              </p>
            </motion.div>
